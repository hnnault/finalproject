...
bgImg = pygame.image.load("Images/Backgrounds/background1.png")
...
def setupBackground(btn):
    ...
    global bgImg, imgsmall
    if btn.name == "1":
        bgImg = pygame.image.load("Images/Backgrounds/background1.png")
        imgsmall = pygame.transform.scale(bgImg, (screen_width, screen_height))

    if btn.name == "2":
        bgImg = pygame.image.load("Images/Backgrounds/background2.png")
        imgsmall = pygame.transform.scale(bgImg, (screen_width, screen_height))

    if btn.name == "3":
        bgImg = pygame.image.load("Images/Backgrounds/background3.png")
        imgsmall = pygame.transform.scale(bgImg, (screen_width, screen_height))
